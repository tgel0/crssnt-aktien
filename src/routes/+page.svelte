...
<div class="page-container">
  ...
  <div class="news-grid">
    ...
    <DataList title="AKTIONÄR" feedURL="https://www.deraktionaer.de/aktionaer-news.rss" numberOfItems="8" />
    ...
    <DataList title="FINANZNACHRICHTEN.DE/NEWS" feedURL="https://www.finanznachrichten.de/rss-aktien-nachrichten" numberOfItems="10"/>
    <DataList title="R/AKTIEN" feedURL="https://www.reddit.com/r/Aktien/new.rss" numberOfItems="10"/>

    <DataList title="FINANZMARKTWELT" feedURL="https://finanzmarktwelt.de/feed" numberOfItems="7" />
    <DataList title="IT TIMES" feedURL="https://www.it-times.de/tag/it-news/rss.xml" numberOfItems="6"/>
